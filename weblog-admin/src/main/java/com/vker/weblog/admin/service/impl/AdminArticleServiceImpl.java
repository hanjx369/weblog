...
import com.vker.weblog.admin.convert.ArticleDetailConvert;
...
public class AdminArticleServiceImpl implements AdminArticleService {
    ...
    public Response<Void> publishArticle(PublishArticleReqVO publishArticleReqVO) {
    ...
    @Override
    @Transactional(rollbackFor = Exception.class)
    public Response<Void> deleteArticle(DeleteArticleReqVO deleteArticleReqVO) {
    ...
    @Override
    @Transactional(rollbackFor = Exception.class)
    public Response<Void> updateArticle(UpdateArticleReqVO updateArticleReqVO) {
    ...
    private void insertTags(Long articleId, List<String> publishTags) {
        ...
        if (CollectionUtils.isEmpty(tagDOS)) {
            ...
            Map<String, Long> tagNameIdMap = tagDOS.stream()
                    .collect(Collectors.toMap(tagDO -> tagDO.getName().toLowerCase(),
                            TagDO::getId, (tagDo1, tagDo2) -> tagDo1));
